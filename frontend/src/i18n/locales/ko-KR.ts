export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      legendRecommended: '다음 학습 추천',
      masteryEvidence: '숙련도 {score}, 인용 {hits}회 기준',
      recommendationAdjacent: '학습한 노드 “{title}”에 직접 연결됨',
      exportLearningProfile: '학습 프로필 내보내기',
      exportLearningProfileSuccess: '학습 프로필을 내보냈습니다',
      exportLearningProfileFailed: '학습 프로필 내보내기에 실패했습니다',
      deleteLearningProfile: '학습 프로필 삭제',
      deleteLearningProfileConfirm: '이 지식 베이스의 학습 프로필을 삭제할까요? 지식 베이스와 다른 사용자에게는 영향을 주지 않습니다.',
      deleteLearningProfileSuccess: '학습 프로필을 삭제했습니다',
      deleteLearningProfileFailed: '학습 프로필 삭제에 실패했습니다',
