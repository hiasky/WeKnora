export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      legendRecommended: '次のおすすめ',
      masteryEvidence: '習熟度 {score}、引用 {hits} 回に基づく',
      recommendationAdjacent: '習得済みノード「{title}」に直接接続',
      exportLearningProfile: '学習プロフィールをエクスポート',
      exportLearningProfileSuccess: '学習プロフィールをエクスポートしました',
      exportLearningProfileFailed: '学習プロフィールのエクスポートに失敗しました',
      deleteLearningProfile: '学習プロフィールを削除',
      deleteLearningProfileConfirm: 'このナレッジベースの学習プロフィールを削除しますか？ナレッジベースや他のユーザーには影響しません。',
      deleteLearningProfileSuccess: '学習プロフィールを削除しました',
      deleteLearningProfileFailed: '学習プロフィールの削除に失敗しました',
