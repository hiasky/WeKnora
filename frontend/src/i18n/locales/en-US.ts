export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      legendRecommended: 'Suggested next',
      masteryEvidence: 'Mastery {score}, based on {hits} citations',
      recommendationAdjacent: 'Directly connected to mastered node “{title}”',
      exportLearningProfile: 'Export learning profile',
      exportLearningProfileSuccess: 'Learning profile exported',
      exportLearningProfileFailed: 'Failed to export learning profile',
      deleteLearningProfile: 'Delete learning profile',
      deleteLearningProfileConfirm: 'Delete your learning profile for this knowledge base? The knowledge base and other users are unaffected.',
      deleteLearningProfileSuccess: 'Learning profile deleted',
      deleteLearningProfileFailed: 'Failed to delete learning profile',
