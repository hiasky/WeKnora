export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      legendRecommended: '建议下一步学习',
      masteryEvidence: '掌握度 {score}，来自 {hits} 次引用',
      recommendationAdjacent: '与已掌握节点「{title}」直接相连',
      exportLearningProfile: '导出学习画像',
      exportLearningProfileSuccess: '学习画像已导出',
      exportLearningProfileFailed: '学习画像导出失败',
      deleteLearningProfile: '删除学习画像',
      deleteLearningProfileConfirm: '删除你在当前知识库中的学习画像？此操作不会影响知识库或其他用户。',
      deleteLearningProfileSuccess: '当前知识库的学习画像已删除',
      deleteLearningProfileFailed: '学习画像删除失败',
