export default {
  ...
  settings: {
    ...
    skills: {
      title: 'Навыки',
      description: 'Установка в образ песочницы. Агенты, использующие эту песочницу, могут выбирать эти навыки.',
      helpTooltip: 'Навыки запекаются в образ выбранной песочницы и применяются со следующей сессии. Агенты, использующие эту песочницу, могут включать и отключать установленные навыки по одному.',
      ...
      installDrawerDesc: 'Установка в образ «{name}». Вставьте источник или загрузите zip.',
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: 'Навыки',
      skillsConfigDesc: 'Выберите песочницу для скриптов навыков, затем укажите, какие установленные навыки доступны агенту. Установка выполняется на странице «Навыки» в настройках пространства.',
      ...
      goSkillSettings: 'Установить навыки',
