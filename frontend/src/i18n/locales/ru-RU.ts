export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      legendRecommended: 'Рекомендуется изучить далее',
      masteryEvidence: 'Освоение {score}, на основе {hits} ссылок',
      recommendationAdjacent: 'Напрямую связано с освоенным узлом «{title}»',
      exportLearningProfile: 'Экспорт профиля обучения',
      exportLearningProfileSuccess: 'Профиль обучения экспортирован',
      exportLearningProfileFailed: 'Не удалось экспортировать профиль обучения',
      deleteLearningProfile: 'Удалить профиль обучения',
      deleteLearningProfileConfirm: 'Удалить ваш профиль обучения для этой базы знаний? База знаний и другие пользователи не пострадают.',
      deleteLearningProfileSuccess: 'Профиль обучения удалён',
      deleteLearningProfileFailed: 'Не удалось удалить профиль обучения',
